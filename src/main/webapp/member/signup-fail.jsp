    ...
    <div class="signup">
        ...
        <form class="signup-form" action="/signup" method="post">
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="password" class="input" name="pw" id="password"
                           placeholder="영문, 숫자, 특수문자를 포함한 6~15자" value="${pw}" required/>
                </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" class="input" name="name" id="name" placeholder="홍길동" value="${name}" required/>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="number" class="input" name="age" id="age"
                           placeholder="나이를 입력해주세요." value="${age}" required>
                </div>
            </div>
            <div>
